  ...
  return <>
    <UnauthenticatedPage pageTitle='Getting Started'>
      <div
        ...
        <Typography.Title>Welcome to Curious Crowd! 🎉</Typography.Title>
        <p>
        ...
        <p>
          Your project source code has been downloaded to a directory called `curious-crowd` within the directory that you ran the `@codegenie/cli generate` command. From the same terminal, you can try running `code curious-crowd`, or you can simply open your favorite IDE (e.g. VS Code) and open the project folder.
        </p>
        <Divider />
